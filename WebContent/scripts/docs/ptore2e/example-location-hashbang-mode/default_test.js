describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("build/docs/examples/example-location-hashbang-mode/indexroute.html");
  });
  
var addressBar = element(by.css("#addressBar")),
     url = 'http://www.example.com/base/indexroute.html#!/path?a=b#h';
...
it("should change $location accordingly", function() {
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/indexroute.html#!/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/indexroute.html#!/sec/ond?flag#hash");
